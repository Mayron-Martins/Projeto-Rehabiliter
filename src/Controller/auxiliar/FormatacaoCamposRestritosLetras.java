 ...
 * @author Mayro
 */
public final class FormatacaoCamposRestritosLetras extends JTextField {
private int maximoCaracteres=-1;// definição de -1 
// como  valor normal de um textfield sem limite de caracters
public FormatacaoCamposRestritosLetras() {
        super();
...
public FormatacaoCamposRestritosLetras(int maximo) {    
    super();
...
//que deve ser aceito no jtextfield que foi recebido no  construtor
    ...
    private void jTextFieldKeyTypedLetras(KeyEvent evt) {
