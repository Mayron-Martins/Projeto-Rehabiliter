...
public class ReferencesTable {
    ...
    public void referencesFreqTurmas() throws SQLException{
        TableCriator turmas = new TableCriator();
    ...
    public void fkTblLogDeAcoesDoFunc_TblFuncionarios(Statement statement, int numeroDoFuncionario) throws SQLException{
        statement.execute(this.alterarTabela+" tblLogdeAcoesdoFun"+numeroDoFuncionario+" "
