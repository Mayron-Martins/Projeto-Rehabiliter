...
public class EnderecoFuncionarioDao extends Conexao{
    ...
    public void inserirDadosEmEnderecoFuncionario(EnderecoFuncionario endereco) throws SQLException{
    ...
    //Remove o endereço
    public void removerEnderecoFuncionario(int codFuncionario) throws SQLException{
    ...
    //Editar o Endereço
    public void atualizarDados(EnderecoFuncionario endereco) throws SQLException{
    ...
    public ArrayList <EnderecoFuncionario> pesquisarEndereco(String comando) throws SQLException{
