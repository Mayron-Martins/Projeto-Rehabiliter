...
public class BackupDao extends ConexaoMaster{
    ...
    public void exportarBanco() throws SQLException{
        PreparedStatement statement = gerarStatement("BACKUP DATABASE Rehabiliter_Database TO DISK = '"+System.getProperty("user.home")+"\\documents\\Rehabiliter\\Backups\\Local\\LocalBackup.bak'");
        statement.execute();
        statement.close();
    }
