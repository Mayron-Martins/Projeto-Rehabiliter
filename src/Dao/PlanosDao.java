...
public class PlanosDao extends Conexao{
    ...
    public void inserirDados (Planos plano){
        try{
            ...
            String inPlanos = inserir.concat("tblPlanos("
                    + "codAluno,codTurma, codServico, dataCadastro, dataPagamento, diaVencimento, dataVencimento, dataCancelamento, dataRenovacao, situacao)"
                    + "VALUES("
            ...
            statement.setDate(3, (Date) plano.getDataCadastro());
    ...
    public ArrayList <Planos> pesquisarPlanos(String comando){
        try{
            ...
            Planos plano = new Planos(chavePlano, codAluno, codTurma, codServico, diaVencimeto, dataCadastro, dataVencimento, dataPagamento, dataCancelamento,dataRenovacao,situacao);
