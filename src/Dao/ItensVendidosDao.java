...
public class ItensVendidosDao extends Conexao{
    ...
    public void inserirDadosEmItensVendidos(PreparedStatement statement, ArrayList<ItemVendido> item){
        try{
    ...
    public ArrayList <ItemVendido> selecionarTodosItensVendidos(){
    ...
    public ArrayList <ItemVendido> pesquisarItensVendidos(String comando){
        try{
